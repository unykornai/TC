...
function checkPackageIntegrity(): CheckResult[] {
  ...
  const requiredSources = ['pipeline.ts', 'xrpl-activator.ts', 'stellar-activator.ts', 'report-generator.ts', 'tx-queue.ts', 'audit-bridge.ts', 'settlement-connector.ts', 'sponsor-note.ts', 'borrowing-base.ts', 'funding-wave-attestation.ts', 'index.ts'];
